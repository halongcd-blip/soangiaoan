...
# -----------------------------------------------------------------
import google.genai as genai # <-- SỬA LỖI ModuleNotFoundError
...
# Khởi tạo MODEL BẰNG CÁCH TRUY CẬP DICTIONARY (Cú pháp ổn định)
# Đây là cách duy nhất để tránh lỗi GenerativeModel và lỗi .get()
